...
- [ADR-003: Status Lifecycle Redesign](003-status-lifecycle-redesign.md) — 4-stage pipeline (backlog → in_progress → approved → posted) + rejected sidetrack, expire logic removal
